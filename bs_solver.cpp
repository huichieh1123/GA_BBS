...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    __pyx_v_t_process = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_t_process == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 245, __pyx_L3_error)
    __pyx_v_t_pick = __Pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_t_pick == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 245, __pyx_L3_error)
...
*/
  ...
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_set_config, __pyx_t_2) < (0)) __PYX_ERR(0, 245, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
